...
# Vamos adicionar a coluna ano "recortando" os 4 primeiros caracteres da data
# com a função substr.
sinistrosRecifeRaw$ano <- substr(sinistrosRecifeRaw$ano,1,4)

# Vamos verificar se o procedimento deu certo apresentando os valores únicos da
# coluna criada com a função unique
unique(sinistrosRecifeRaw$ano)
